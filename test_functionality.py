...
print("="*50)
print("\nThe application window should be open.")
print("You can now:")
print("1. Click 'Load TSV' and select the sample file")
print("2. Configure groups and tasks")
print("3. Click 'Show Results' to see the analysis")
print("4. Click 'Print Executive Summary' to generate a summary")
